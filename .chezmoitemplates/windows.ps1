...
Guru3D.Afterburner Guru3D.RTSS OPAutoClicker.OPAutoClicker Logitech.OnboardMemoryManager ` # gaming
Valve.Steam Discord.Discord FACEITLTD.FACEITAC `
TeamSpeakSystems.TeamSpeakClient.Beta Peppy.Osu! ` # misc
